...
util_settings.validators.register(
    ...
    Validator("generator.data.landcover_index_path", cast=str, default=_landcover_index_path), 
    Validator("generator.data.material_config_path", cast=str, default=_material_config_path), 
)
